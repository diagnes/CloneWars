 ...
 */
public class Jawa extends Good implements HasNoForce {

    // Construction de la base de notre Class Jawa
    ...
    public Jawa(Save game){
        this.setName(game.getName());
        this.setHp(400 + (20 * (game.getLvl() - 1)));
        this.setDef(400 + (10 * (game.getLvl() - 1)));
        this.setPower(400 + (10 * (game.getLvl() - 1)));
        this.setIntelligence(400 + (10 * (game.getLvl() - 1)));
    ...
    public void getIn() {
        if (this.getXp() == 0)
            System.out.println("Bienvenue valeureux Jawa " + this.getName() + ". L'aventure peux enfin commencé");
        else
            System.out.println("Bienvenue valeureux Jawa " + this.getName() + ". Votre aventure peux continuer");
    }
