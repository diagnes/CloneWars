 ...
 */
public class BountyHunters extends Good implements HasNoForce {

    // Construction de la base de notre Class BountyHunter
    ...
    public BountyHunters(Save game){
        this.setName(game.getName());
        this.setHp(100 + (20 * (game.getLvl() - 1)));
        this.setDef(100 + (10 * (game.getLvl() - 1)));
        this.setPower(100 + (5 * (game.getLvl() - 1)));
        this.setIntelligence(350 + (5 * (game.getLvl() - 1)));
    ...
    public void getIn() {
        if (this.getXp() == 0)
            System.out.println("Bienvenue valeureux BountyHunter " + this.getName() + ". L'aventure peux enfin commencé");
        else
            System.out.println("Bienvenue valeureux BountyHunter " + this.getName() + ". Votre aventure peux continuer");
    }
    ...
    public int armedAttack(Personnage ennemy){
        ...
        atck = (int)(this.getIntelligence() - ennemy.getDef() * 0.2);
        if (atck <= 0){
            atck = 3;
