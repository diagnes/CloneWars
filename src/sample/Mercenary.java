 ...
 */
public class Mercenary extends Good implements HasNoForce {

    // Construction de la base de notre Class Mercenary
    ...
    public Mercenary(Save game){
        this.setName(game.getName());
        this.setHp(100 + (40 * (game.getLvl() - 1)));
        this.setDef(350 + (5 * (game.getLvl() - 1)));
    ...
    public void getIn() {
        if (this.getXp() == 0)
            System.out.println("Bienvenue valeureux Mercenary " + this.getName() + ". L'aventure peux enfin commencé");
        else
            System.out.println("Bienvenue valeureux Mercenary " + this.getName() + ". Votre aventure peux continuer");
    }
