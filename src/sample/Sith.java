 ...
 */
public class Sith extends Good implements HasForce {

    // Construction de la base de notre Class Sith
    ...
    public void getIn() {
        if (this.getXp() == 0)
            System.out.println("Bienvenue valeureux Sith " + this.getName() + ". L'aventure peux enfin commencé");
        else
            System.out.println("Bienvenue valeureux Sith " + this.getName() + ". Votre aventure peux continuer");
    }
